...
void ATestMultiplayerCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ATestMultiplayerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATestMultiplayerCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATestMultiplayerCharacter::Look);

	}

}

void ATestMultiplayerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATestMultiplayerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATestMultiplayerCharacter::Tick(float DeltaTime)
{
